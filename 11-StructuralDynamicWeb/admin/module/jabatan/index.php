            ...
            <div class="table-responsive small">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $query = "SELECT * FROM jabatan order by jabatan_id desc";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?page=jabatan/edit&id=<?php echo $row['jabatan_id']; ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                                    <a href="fungsi/hapus.php?jabatan=hapus&id=<?php echo $row['jabatan_id']; ?>" onclick="javascript:return confirm('Hapus Data Jabatan ?');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o" aria-hidden="true"></i> Hapus</a>
                                </td>
                            </tr>
                        <?php
                        }
